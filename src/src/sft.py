...
def main():
    ...
    trainer = QwenTrainer(
        ...
        output_dir="/home/shangbin/curiosity_math/models/qwen-math-sft",
        dataset_path="/home/shangbin/curiosity_math/datasets/organized_math_train/math_dataset_sft.jsonl",
